...
namespace ProjetoBanco
{
    ...
    public PessoaFisica(string nome, string cpf, DateTime dataNascimento, int idade, int numeroConta, string email,     string telefone,string end) : base (email, telefone, end, numeroConta, tipoConta)
    {
        Nome = nome;
        CPF = cpf;
